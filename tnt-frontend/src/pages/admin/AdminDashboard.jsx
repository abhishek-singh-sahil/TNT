  ...
  return (
    <div className="space-y-8 pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-paper border border-line rounded-xl p-6 shadow-xs flex flex-col justify-between">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-2">
              <div className="border-r border-line pr-2">
                ...
                <span className="text-base font-extrabold text-ink block">{formatCurrency(salesPerformance.revenue)}</span>
                <span className="text-[9px] text-emerald-600 font-bold">
                  {kpis.revenue.change >= 0 ? '↑' : '↓'} {Math.abs(kpis.revenue.change)}% vs last period
                </span>
              </div>
              <div className="sm:border-r border-line pr-2">
                ...
                <span className="text-base font-extrabold text-ink block">{salesPerformance.orders}</span>
                <span className="text-[9px] text-emerald-600 font-bold">
                  {kpis.orders.change >= 0 ? '↑' : '↓'} {Math.abs(kpis.orders.change)}%
                </span>
              </div>
              <div className="border-r border-line pr-2">
                <span className="text-[9px] font-bold text-muted uppercase tracking-wider block">Average Order Value</span>
                <span className="text-base font-extrabold text-ink block">{formatCurrency(salesPerformance.aov)}</span>
                <span className="text-[9px] text-emerald-600 font-bold">
              ...
              <div>
                ...
                <span className="text-base font-extrabold text-ink block">{salesPerformance.newCustomers}</span>
                <span className="text-[9px] text-emerald-600 font-bold">
                  Registered signups
                </span>
              </div>
